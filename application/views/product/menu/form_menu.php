<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title"><?= ucfirst($page) ?> menu</h4>
...
<div class="container-fluid">
    <form action="<?= site_url('menu/proses') ?>" method="POST" class="tm-signup-form row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama" required name="nama" type="text" class="form-control validate" value="<?= $row->nama ?>" />
