                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item"> <a href="<?= site_url('sales') ?>" class="sidebar-link"><i class="mdi mdi-cart-outline"></i><span class="hide-menu"> Penjualan 
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-archive"></i><span class="hide-menu">Stock</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-bulletin-board"></i><span class="hide-menu">Rekap </span></a>
                            ...
                            <li class="sidebar-item"><a href="<?= site_url('rekap_modal/excel') ?>" class="sidebar-link"><i class="mdi mdi-cart-off"></i><span class="hide-menu"> Laporan Penjualan </span></a></li>
                                <li class="sidebar-item"><a href="<?= site_url('laba')?>" class="sidebar-link"><i class="mdi mdi-calendar-check"></i><span class="hide-menu"> Laba
                                        </span></a></li>
                               
                                        </span></a></li>
                            <?php } ?>
                                <li class="sidebar-item"><a href="<?= site_url('toko')?>" class="sidebar-link"><i class="mdi mdi-bulletin-board"></i><span class="hide-menu"> Toko
                                        </span></a></li>
                                <li class="sidebar-item"><a href="<?= site_url('jasa')?>" class="sidebar-link"><i class="mdi mdi-message-outline"></i><span class="hide-menu">
                                            Jasa</span></a></li>
                            </ul>
                        </li>
                        <?php if ($this->fungsi->user_login()->level == 1) { ?>
