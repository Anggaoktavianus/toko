...
<div class="container-fluid">
    <form action="<?= site_url('aset/proses/') ?>" method="POST" class="tm-signup-form row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nilai" required name="nilai" type="text" class="form-control validate" value="<?= $row->nilai ?>" />
