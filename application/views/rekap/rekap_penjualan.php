                    ...
                    <form method="get" action="<?= base_url('rekap')?>">
                        ...
                        <div class="row" id="form-tanggal">
                            <div class="col-sm-3 col-md-2">
                                ...
                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input type="datetime-local"  name="tanggal" class="form-control " autocomplete="off" required/>
                            ...
                            <div class="col-sm-3 col-md-2">
                                <div class="form-group">
                                    <label>Sampai</label>
                                    <input type="datetime-local" name="tanggal1" class="form-control " autocomplete="off" required/>
                        ...
                        <button type="submit" id="tampil" class="btn btn-primary">Tampilkan</button>
                        <a href="<?= site_url('rekap/') ?>" class="btn btn-default">Reset Filter</a>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered" style="width: 100%;">
                            ...
                            <thead>
                                <tr>
                                        ...
                                        <th>Kode Barang</th>
                                        <th>Nama Barang</th>
                                        <th>Terjual<small>(Box/Pcs)</small></th>
                                        <th>Sisa<small>(Box/Pcs)</small></th>
                                        <th>Harga Jual</th>
                                        <th>Subtotal</th>
                                        <th>Diskon</th>
                                        <th>Jasa</th>
                               ...
                               <?php
                                if( ! empty($transaksi)){
                                    ...
                                    foreach($transaksi as $data){
                                        ...
                                        echo "<td>".number_format($data->harjul)."</td>";
                            ...
                            <tfoot>
                                <tr>
                                        ...
                                        foreach($total as $data){ // Ambil data tahun dari model yang dikirim dari controller
                                            ...
                                            echo "<th>"."<b>".number_format($data->diskon)."</th>";
