...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('aset/fonts/icomoon/style.css') ?>">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-md-2">
                    <img src="<?= base_url('aset/images/undraw_file_sync_ot38.svg') ?>" alt="Image" class="img-fluid">
                </div>
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="mb-4">
                                <h3>Sign In to <strong>POS Admin</strong></h3>
                                <p class="mb-4">Pastikan username dan password yang anda masukkan sudah benar</p>
                            </div>
    ...
    <script src="<?= base_url('aset/js/jquery-3.3.1.min.js') ?>"></script>
