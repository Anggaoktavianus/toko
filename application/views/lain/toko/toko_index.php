        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= site_url('toko/add/') ?>" class="btn btn-primary btn-sm "><i class="fas fa-plus-circle ">Tambah data</i></a>
                    <br><br>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= site_url('toko/del/' . $data->id) ?>" onclick="return confirm('Apakah anda yakin ?')" class="btn btn-danger text-white">
