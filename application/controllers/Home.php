...
class Home extends CI_Controller
{
	...
	function __construct()
    {
        ...
        $this->load->model(['m_items', 'm_category', 'm_unit', 'm_rekap','m_user']);
    }
	public function index()
	{
        ...
        $data['penjualan'] = $this->db->query("SELECT a.*, b.name as namaproduk, SUM(a.d_jual_qty) as qty, SUM(a.d_jual_qty_satuan) as satuan 
        FROM tbl_detail_jual a 
        INNER JOIN items b ON b.barcode = a.d_jual_barang_id 
        WHERE a.d_jual_barang_id = b.barcode GROUP BY a.d_jual_barang_id ORDER By a.d_jual_id DESC")->result();
